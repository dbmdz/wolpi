...
public record ValidationTest(
        String pythonImportString,
        String name,
        String category,
        Map<IIIFVersion, IIIFComplianceLevel> complianceLevel,
    ...
    public static ValidationTest fromPyClass(Value pyClass) {
        ...
        if (compliance.hasHashEntries()) {
            ...
            while (it.hasIteratorNextElement()) {
                ...
                int complianceLevelVal =
                        compliance.getHashValue(versionEnum).getMember("value").asInt();
            ...
            var complianceLevel = Objects.requireNonNull(
                    IIIFComplianceLevel.fromInt(compliance.getMember("value").asInt()));
        ...
        String importString = "from %s import %s"
                .formatted(
