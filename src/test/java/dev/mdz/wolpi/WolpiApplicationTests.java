...
class WolpiApplicationTests {
  ...
  public static class ValidationTestProvider implements ArgumentsProvider {
    ...
    public Stream<? extends Arguments> provideArguments(ExtensionContext context) throws Exception {
      ...
      return testInstance.imageApiValidator.getAllTests()
          .stream()
  ...
  public static class ValidationResultAssert extends
      AbstractAssert<ValidationResultAssert, ValidationResult> {
    ...
    public ValidationResultAssert isSuccess() {
      isNotNull();
      if (actual instanceof ValidationFailure(
          String expected, String received, java.net.URI url, String details
      )) {
        failWithMessage("Validation failed: %s. Expected: '%s', but got: '%s'. URL was '%s'".formatted(
            details, expected, received, url));
      }
      return this;
    }
  }
